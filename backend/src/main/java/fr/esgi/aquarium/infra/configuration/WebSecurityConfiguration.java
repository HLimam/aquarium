package fr.esgi.aquarium.infra.configuration;


import fr.esgi.aquarium.infra.security.JwtConfigurer;
import fr.esgi.aquarium.infra.security.oauth2.CustomOAuth2UserService;
import fr.esgi.aquarium.infra.security.oauth2.OAuth2SuccessHandler;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedHeaders(Collections.unmodifiableList(Collections.singletonList("*")));
