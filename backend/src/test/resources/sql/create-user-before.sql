...
-- password: admin123
insert into users(id, email, first_name, last_name, city, address, phone_number, post_index, activation_code, active, password, password_reset_code, provider)
    values(122, 'annual.projects.4th.test@gmail.com', 'John', 'Doe', 'New York', 'Wall Street 1', '1234567890', '1234567890', null, true, '$2a$08$kS2f5m8eYoNpc.ZECzndGuXiqaWmCaFfOGMQquodP48qrD7.cQG4y', null, 'LOCAL');
